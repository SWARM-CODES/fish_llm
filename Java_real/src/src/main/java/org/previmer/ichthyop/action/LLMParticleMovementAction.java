...
public class LLMParticleMovementAction extends AbstractAction {
    ...
    public void execute(IParticle particle) {
        ...
        try {
            ...
            //updateLLM is one loop after updateHistory, as dt is small due to CFL condition
            boolean updateHistory = Math.abs(age % UPDATE_HISTORY_INTERVAL) < 1e-3;
            boolean updateLLM     = Math.abs((age - dt) % UPDATE_LLM_INTERVAL) < 1e-3;
